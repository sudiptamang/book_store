    ...
    <div>
      ...
      <div class="ForgotPasswordContainer">
        ...
        <div class="newPassword">
          ...
          <input type="password" placeholder="New Password" required    className="newPasswordInput"/>
          <div>Must be at least 8 character</div>
        </div>
        <div class="newPassword">
          <div className="password">Confirm New Password</div>
          <input type="password" placeholder="Re-New Password" required  className="newPasswordInput"/>
